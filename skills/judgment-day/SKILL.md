...
1. Obtain the skill registry: read `.atl/skill-registry.md` from the project root (project-local) → fallback to `~/.claude/skills/SKILL-REGISTRY.md` (global) → skip if none
